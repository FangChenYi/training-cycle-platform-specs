...
- [2.1 As-Is 流程盤點](#21-as-is-流程盤點)
  - [流程 A — 教練排課](#流程-a--教練排課)
  - [流程 B — VALD 檢測資料查詢與紀錄](#流程-b--vald-檢測資料查詢與紀錄)
  - [流程 C — 學員現場查課](#流程-c--學員現場查課)
- [2.2 To-Be 流程設計](#22-to-be-流程設計)
  - [流程 A' — 教練排課（新）](#流程-a--教練排課新)
  - [流程 B' — VALD 同步（新）](#流程-b--vald-同步新)
  - [流程 C' — 學員今日訓練（新）](#流程-c--學員今日訓練新)
- [2.3 Gap 分析](#23-gap-分析)
- [2.4 範圍界定 Scope](#24-範圍界定-scope)
  - [In Scope（第一版交付）](#in-scope第一版交付)
  - [Out of Scope（後續迭代或不在本案內）](#out-of-scope後續迭代或不在本案內)
  - [前置假設](#前置假設)
  - [限制](#限制)
- [2.5 可行性評估](#25-可行性評估)
  - [技術可行性](#技術可行性)
  - [整合可行性 — VALD Performance](#整合可行性--vald-performance)
  - [VALD Profile 同步策略：從雙向到單向](#vald-profile-同步策略從雙向到單向)
  - [主要風險與因應](#主要風險與因應)
- [小結](#小結)
